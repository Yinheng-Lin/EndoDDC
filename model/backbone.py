...
class Backbone(nn.Module):
    def __init__(self, args, mode='rgbd'):
        ...
        if self.args.prop_time > 0:
            self.gd_dec1 = conv_bn_relu(64+decoder_input_channel, 64, kernel=3, stride=1,
                                        padding=1)
        ...
        if self.args.prop_time > 0 and self.args.conf_prop:
            self.cf_dec1 = conv_bn_relu(64+decoder_input_channel, 32, kernel=3, stride=1,
                                        padding=1)
    ...
    def forward(self, rgb=None, depth=None):
        ...
        return init_depth, guide, confidence, context, confidence_input
