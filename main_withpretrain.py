...
import utility
from model.ognidc_lrdm import OGNIDC
...
def train(gpu, args):
    ...
    for epoch in range(args.start_epoch, args.epochs+1):
        ...
        for batch, sample in enumerate(loader_train):
            ...
            noise_loss, scc_loss = net.module.noise_estimation_loss(output)
            print("noise_loss is : ", noise_loss)
            print("scc_loss is : ", scc_loss)
            loss_lrdm = noise_loss+scc_loss
            ...
            loss_lrdm = loss_lrdm / loader_train.batch_size


            with amp.scale_loss(loss_sum, optimizer) as scaled_loss:
                scaled_loss.backward()

            # with amp.scale_loss(loss_lrdm, optimizer) as scaled_loss:
            #     scaled_loss.backward()
