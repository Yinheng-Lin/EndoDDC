...
python main.py --dir_data /hy-tmp/dataset/stereomis_sample --data_name stereomis --split_json /hy-tmp/dataset/stereomis_sample/dataset_c3vd.json \
    ...
    --log_dir /hy-tmp/result/withDDI/OGNIDC_stereomis_test_ \
    --save "withDDI"