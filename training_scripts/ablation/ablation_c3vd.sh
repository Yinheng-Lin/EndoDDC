...
python main_withoutDDI.py --dir_data /hy-tmp/c3vd_h5 --data_name c3vd --split_json /hy-tmp/c3vd_h5/c3vd.json \
    --gpus 0  \
    --max_depth 100.0 \
    ...
    --log_dir /hy-tmp/result/ablation/baseline_withoutDDI_finetune_gru1_ \
    --save "c3vd" 